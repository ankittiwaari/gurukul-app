export default menuItems = [
    {id:"c1", title:"My Profile", icon:"user-o", navigationTarget:"MyProfile"},
    {id:"c2", title:"Remarks", icon:"comment", navigationTarget:"Remarks"},
    {id:"c3", title:"Result", icon:"file-text-o", navigationTarget:"Result"},
    {id:"c4", title:"Downloads", icon:"download", navigationTarget:"Downloads"},
    {id:"c5", title:"Attendance", icon:"users", navigationTarget:"Attendance"},
